...
- **📪 Ulaşmayanlar**: sayfanın en üstünde, mail geri dönen (bounce/teslim edilemedi)
  ...
  - **Bounce tespiti güçlendirildi**: sistem artık gelen kutusunda çok daha geniş bir
    ...
    yanlışlıkla normal bir yanıt gibi sayılabiliyordu. Not: hiçbir yöntem teslim
    edilemedi bildirimlerinin %100'ünü yakalayamaz (her mail sunucusu farklı formatta
    bildirim gönderebilir) — kapsam önemli ölçüde genişledi ama garanti değil.
